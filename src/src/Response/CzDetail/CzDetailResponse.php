...
class CzDetailResponse extends BaseResponse
{
     ...
     * @return string|NULL
     */
    public function getCzNaceCode()
    {
        return $this->czNaceCode;
    }

    public function setCzNaceCode(string $czNaceCode = NULL): self
    {
     ...
     * @return string|NULL
     */
    public function getCzNaceText()
    {
        return $this->czNaceText;
    }

    public function setCzNaceText(string $czNaceText = NULL): self
    {
     ...
     * @return string|NULL
     */
    public function getCzNaceDivision()
    {
        return $this->czNaceDivision;
    }

    public function setCzNaceDivision(string $czNaceDivision = NULL): self
    {
     ...
     * @return string|NULL
     */
    public function getCzNaceGroup()
    {
        return $this->czNaceGroup;
    }

    public function setCzNaceGroup(string $czNaceGroup = NULL): self
    {
